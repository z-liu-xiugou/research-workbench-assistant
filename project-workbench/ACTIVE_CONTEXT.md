...
- 2026-09-18 维护检查：55 Stars，无开放 PR；新增 #7 安装失败完整性、#8 分页升级指南、#9 外部试用验收。优先推进 #7。
- tests 工作流新增每日北京时间 09:17 调度；范围为测试与公开文件检查。AI 自动修复任务尚未创建，建议指令见 docs/DAILY_MAINTENANCE.md。

1. 核对 alpha.8 对应提交的 CI；收集摘要搜索、分页与 search 输出兼容性反馈。2026-09-13 检查时 16 Stars，无开放 Issue/PR。
